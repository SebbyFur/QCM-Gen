...
@section('content')
<div class="container">
    <h1 class="text-center my-5">Edition de la question #{{ $ret['question'][0]['id'] }}</h1>
    <div class="container">
        <div class="container">
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control mx-2 question-input" value='{{ $ret['question'][0]['question'] }}' placeholder="Entrez une question...">
...
<script type="text/javascript">
    const ID_QUESTION = +"{{ $ret['question'][0]['id'] }}";
