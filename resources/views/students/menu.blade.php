    ...
    <div class="row">
            ...
            <div class="mx-4 border border-1" style='background-color: #f9f9f9;'>
                ...
                <div class="d-flex justify-content-center my-2 dropup">
                    ...
                    <div class='dropdown-menu px-3 text-center' aria-labelledby="dropdownMenuLink">
                        <input type="text" class="form-control student-firstname-input" placeholder="Entrez un nom...">
                        <input type="text" class="form-control my-2 student-lastname-input" placeholder="Entrez un prénom...">
        ...
        <div class="col-6">
            <div class="mx-4 border border-1" style='background-color: #f9f9f9;'>
                ...
                <div class="d-flex justify-content-center my-2">
                    <button type='button' class='add-student btn btn-success w-50'><i class="bi bi-plus-circle-fill icon-add"></i></button>
                </div>
            </div>
        </div>
    </div>
